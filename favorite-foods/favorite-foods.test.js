...
describe("favorite foods", function () {
  ...
  it.skip("should have ingredients", function () {
    ...
    assert.deepEqual(tacos.ingredients, [
      "Tortilla",
      "Ground Beef",
      "Lettuce",
      "Tomatoes",
  ...
  it.skip("should be able to have different ingredients", function () {
    ...
    assert.deepEqual(burger.ingredients, [
      "Bun",
      "Beef Patty",
      "Lettuce",
      "Tomato",
    ...
    assert.deepEqual(sushi.ingredients, [
      "Rice",
      "Salmon",
      "Tuna",
      "Avocado",
  ...
  it.skip("should be spicy or not", function () {
    var pancakes = createFavoriteFood({
      dish: "Pancakes",
      ingredients: ["Flour", "Egg", "Milk", "Butter", "Maple Syrup"],
      isSpicy: false,
    });
    var padThai = createFavoriteFood({
      dish: "Pad Thai",
      ingredients: [
        "Rice Noodles",
        "Shrimp",
    ...
    assert.deepEqual(pancakes.ingredients, [
      "Flour",
      "Egg",
      "Milk",
      "Butter",
    ...
    assert.deepEqual(padThai.ingredients, [
      "Rice Noodles",
      "Shrimp",
      "Tofu",
      "Egg",
  ...
  it.skip("should start off having ordered 0 times", function () {
    var dish = createFavoriteFood(
      "Falafel",
      ["Chickpeas", "Garlic", "Onion", "Cumin", "Tahini", "Pita Bread"],
      true
    );
  ...
  it.skip("should be able to order dishes", function () {
    ...
    var dish2 = createFavoriteFood({
      dish: "Chicken Curry",
      ingredients: ["Chicken", "Coconut Milk", "Onion", "Garlic", "Rice"],
      isSpicy: true,
    });
    var dish3 = createFavoriteFood({
      dish: "Ice Cream",
      ingredients: [
        "Milk",
        "Cream",
  ...
  it.skip("should be able to make a list of all ingredients needed for multiple dishes", function () {
    var pizza = createFavoriteFood({
      dish: "Pizza",
      ingredients: ["Tomato Sauce", "Cheese", "Pepperoni", "Mushrooms"],
      isSpicy: false,
    });
    var smoothie = createFavoriteFood({
      dish: "Smoothie",
